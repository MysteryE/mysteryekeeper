							...
							<table id="relic-table" class="table bordered striped compact" style="width: 100%;">
						        ...
						        <tbody>
						            ...
						            <tr>
						                <td>FF1</td>
						                <td>Meia</td>
						                <td>Mellow Mermaid</td>
						                <td>USB</td>
						                <td>Water / NE</td>
						                <td>En-water. Ten single attacks (1.70 each), grants Attach Water, Awash Follow-Up and Surging Wave 0 to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Ten single attacks (1.68 each), MAG and RES +30% to the user for 25 seconds, grants Witch Quick Cycle and Tceles Nottub B Follow-Up to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Glint</td>
						                <td></td>
						                <td>Grants Twin Element Mode II (Earth/Holy), grants High Quick Cast 1</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						                ...
						                <td>AASB</td>
						                <td>Medica</td>
						                <td>Restores HP (105), grants [Last Stand] and [Haste], grants [Awoken Whimsical Fairy] and [Whimsical Aid Follow-Up] to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						                ...
						                <td>USB</td>
						                <td></td>
						                <td>DEF and MAG +30% for 25 seconds, grants Haste, Protect and Quick Cast 2	</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Glint 1</td>
						                <td></td>
						                <td>Grants Shell, Haste and Stoneskin: 30%</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>BSB</td>
						                <td>NE</td>
						                <td>Ten single attacks (0.78 each), grants [Haste], [Critical Chance 50%], [Last Stand] and [Burst Mode] to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF1</td>
						                <td>Thief(I)</td>
						                <td>Brigand's Gloves</td>
						                <td>LMR 2</td>
						                <td></td>
						                <td>25?% chance to grant Quick Cast 1 to the user after using a Wind or Poison attack	</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
									...
									<tr>
						                ...
						                <td>AASB</td>
						                <td>Dark / NE</td>
						                <td>En-dark. Fifteen single attack (0.60 each), grants [Attach Dark], [Awoken Darkness], [Damage Cap +10000] and [Knight in the Dark Follow-Up] to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB 3</td>
						                <td>Dark / NE</td>
						                <td>En-dark. Ten single attacks (0.71 each), grants [Dark Radiant Shield: 75%] to all allies, grants [Attach Dark with Stacking] and [Instant Cast 1] to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>AASB</td>
						                <td>Earth / NE</td>
						                <td>En-earth. Fifteen single attacks (1.50 each), grants Attach Earth, Awoken Earth, Damage Cap +10000 and Kaus Australis Follow-Up</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Fifteen single attacks (1.50 each), grants [Awoken Imperial Mode], [Damage Cap +10000], [Buff Earth 30% (15s)], [Buff Wind 30% (15s)], [Buff Dark 30% (15s)] and [Resist Break Follow-Up] to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB 2</td>
						                <td>Earth / NE</td>
						                <td>En-earth. Ten single attacks (? each), grants Attach Earth with Stacking, Quick Cast 1 and Gaia Stamp Follow-Up to the user	</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>AASB</td>
						                <td></td>
						                <td>Grants High Quick Cast 3, grants Awoken Ruler's Pride, Sorrow of Loss Follow-Up and Sorrow of Loss Counter to the user	</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						                ...
						                <td>USB</td>
						                <td></td>
						                <td>Six group attacks (0.89 each), ATK, MAG and MND -50% for 25 seconds, grants Haste and High Regen to all allies</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						                ...
						                <td>Glint</td>
						                <td>Fire / NE</td>
						                <td>Six single attacks (0.52 each), causes ATK and MAG -40% for 15 seconds</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>BSB</td>
						                <td>Medica</td>
						                <td>Restores HP (85), grants [Magical Blink 1], grants [Haste] and [Burst Mode] to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
									...
									<tr>
						                ...
						                <td>AASB</td>
						                <td>Earth / NE</td>
						                <td>En-earth. Fifteen single attacks (0.60 each), grants Attach Earth, Awoken Earth and Damage Cap +10000 to the user, grants Earth Radiant Shield: 75% to all allies</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
									<tr>
						            ...
						            <tr>
						                ...
						                <td>Glint</td>
						                <td>Earth / NE</td>
						                <td>Six single attacks (0.52 each), restores 1500 HP to all allies</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
									...
									<tr>
						                ...
						                <td>AOSB</td>
						                <td>Holy / Water / NE</td>
						                <td>Twenty single hybrid attacks (1.82 or 1.92 each), followed by one single hybrid attack (26.50 or 28.00) capped at 99999</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
									<tr>
									...
									<tr>
						                ...
						                <td>USB 2 / BUSB</td>
						                <td>Medica</td>
						                <td>Restores HP (85), RES +100% for 25 seconds, grants Brave Mode to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
									<tr>
						                ...
						                <td>Glint+</td>
						                <td></td>
						                <td>Imperil Water & Holy. Causes Medium Imperil Holy and Medium Imperil Water, grants Instant Cast 1 to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
									<tr>
						                ...
						                <td>Glint</td>
						                <td></td>
						                <td>Grants [Summoning High Quick Cast] and Summoning smart ether 2 to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Glint</td>
						                <td></td>
						                <td>Grants High Quick Cast 2, grants Explosive Rush Mode 1/2/3/3 if the user has Explosive Rush Mode 0/1/2/3</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>SSB</td>
						                <td>Lightning / NE</td>
						                <td>Six random attacks (2.94 each), causes [Imperil Lightning 20%] for 25 seconds, [MAG +30%] to the user for 25 seconds</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB 1</td>
						                <td>Wind / NE</td>
						                <td>En-wind. Ten single attacks (0.72 each), grants Attach Wind, EX: Windborn and High Quick Cast 1 to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						                ...
						                <td>USB 2</td>
						                <td>Wind / NE</td>
						                <td>En-wind. Ten single attacks (0.71 each), grants Attach Wind, Wind Drain and Gale Spear Follow-Up to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>BSB</td>
						                <td>Wind / NE</td>
						                <td>En-wind. Eight single ranged attacks (0.78 each), causes Stun (100%), grants Haste, Attach Wind and Burst Mode to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB</td>
						                <td>Earth / NE</td>
						                <td>Imperil 20. Six group ranged attacks (1.03 each), causes Imperil Earth 20% for 25 seconds</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Glint 2</td>
						                <td></td>
						                <td>En-holy. Grants Attach Holy Stacking, Attach Holy and Knight High Quick Cast</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>AASB</td>
						                <td>Lightning / NE</td>
						                <td>En-lightning. Fifteen single attacks (1.50 each), grants Attach Lightning, Awoken Lightning, Damage Cap +10000 and Rising Thunder to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						                ...
						                <td>LB Glint</td>
						                <td></td>
						                <td>En-Lightning to party, Instant Cast.</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Chain / Gen.2</td>
						                <td>Holy</td>
						                <td>Holy chain (magic). Activates Holy Chain (max 150, field +50%), MAG and MND +30% for 25 seconds</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB 3 / BUSB</td>
						                <td>Earth</td>
						                <td>En-earth. Ten single attacks (1.73 each), grants Attach Earth, Quick Cast and Brave Mode to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Glint+ 2</td>
						                <td></td>
						                <td>Grant [Tri Element Mode II (Water/Earth/Holy)], smart summoning ether 2</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Glint</td>
						                <td></td>
						                <td>Grants Magical Quick Cast and Darkness Rank Boost	</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>AASB</td>
						                <td>Medica</td>
						                <td>Restores HP (105), removes KO [Raise: 100%], grants [Magical High Quick Cast 3], [Haste] and [Last Stand], grants [Awoken Cry] to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						                ...
						                <td>USB 1</td>
						                <td>Medica</td>
						                <td>Restores HP (85), grants Last Stand and Reraise: 40%</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Glint+</td>
						                <td></td>
						                <td>En-lightning. Grants Attach Lightning with Stacking and High Quick Cast 2 to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Fuma Shuriken</td>
						                <td>AOSB</td>
						                <td>Water / Fire / Lightning</td>
						                <td>Three single ranged hybrid attacks (8.00 or 3975.00 each) capped at 99999. ignores RES</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Glint+</td>
						                <td></td>
						                <td>Grants Weakness +30% Boost for 15 seconds and High Quick Cast 2</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>LMR 2</td>
						                <td></td>
						                <td>25% chance to cast Brash Prince after using a Ninja ability</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF4</td>
						                <td>Rubicante</td>
						                <td>Darksteel Claw</td>
						                <td>USB</td>
						                <td>Fire / Dark</td>
						                <td>Imperil fire (2). Ten single attacks (1.70 each), causes Imperil Fire 20%, grants Attach Fire and Quick Cast 3 to the user, grants Fire Radiant Shield: 75% to all allies.</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						                <td>FF4</td>
						                <td>Rubicante</td>
						                <td>Rubicante's Grasp</td>
						                <td>SSB</td>
						                <td>Fire / NE</td>
						                <td>Eight random attacks (2.21 each), causes [Imperil Fire 20%] for 25 seconds</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						                ...
						                <td>AASB</td>
						                <td>Holy / NE</td>
						                <td>En-holy. Fifteen single attacks (1.60 each), grants [Attach Holy], [Awoken Highborn], [Damage Cap +10000] to the user, grants [Regenga] to all allies</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						                ...
						                <td>AOSB</td>
						                <td>Holy</td>
						                <td>Three single attacks (9.33 each) capped at 99999</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						                ...
						                <td>Glint</td>
						                <td></td>
						                <td>Grants [Attach Holy with Stacking] and [High Quick Cast 2]</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            ...
						            <tr>
						                ...
						                <td>USB 3</td>
						                <td>Wind / NE</td>
						                <td>En-wind. Ten single attacks (0.71 each), grants Attach Wind and EX: Essence of Wind to the user	</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB 3</td>
						                <td>Dark / Holy</td>
						                <td>Ten single attacks (1.70 each), MAG, RES and MND +30% to the user for 25 seconds, grants Major Buff Holy/Dark and Delta Magic Follow-Up to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF5</td>
						                <td>Faris</td>
						                <td>Faris's Longcoat</td>
						                <td>USB 1</td>
						                <td></td>
						                <td>Six group attacks (0.78~1.29 each scaling with targets), ATK, DEF, MAG, RES and MND -30% for 25 seconds, causes Stun (100%)</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB 1</td>
						                <td>NE</td>
						                <td>Ten single attacks (0.72 each), grants High Retaliate, 50% Critical, and EX: Legendary Swordsman to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF5</td>
						                <td>Gilgamesh</td>
						                <td>Masamune Dimensional</td>
						                <td>Glint 1</td>
						                <td></td>
						                <td>Grants [Stoneskin: 30%], [RES +100%] for 25 seconds</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF5</td>
						                <td>Gogo</td>
						                <td>Rod of the Deeps</td>
						                <td>AASB</td>
						                <td>Water / NE</td>
						                <td>En-water. Fifteen single attacks (1.50 each), grants Attach Water, Awoken Water, Damage Cap +10000 to the user, casts the last ability used by an ally twice, default ability (PHY: single, 1.50 physical)</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>SASB</td>
						                <td>Medica</td>
						                <td>Restores HP (105), grants High Quick Cast 2 and En-Heal 30%, grants Synchro Mode and Damage Cap +10000 to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>BSB 1</td>
						                <td>Medica</td>
						                <td>Restores HP (55), grants Reraise: 40%, RES and MND +30% to the user for 25 seconds, grants Haste and Burst Mode to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Chain / Gen.2</td>
						                <td>Earth</td>
						                <td>Activates Earth Chain (max 150, field +50%), [ATK +50%] for 25 seconds</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Glint</td>
						                <td>Earth / NE</td>
						                <td>Six single attacks (0.52 each), grants [Attach Earth Stacking] and [Attach Earth] to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF5</td>
						                <td>Xezat</td>
						                <td>Freezing Blade</td>
						                <td>AOSB</td>
						                <td>Ice / Earth / Lightning</td>
						                <td>Three single attacks (8.00 each) capped at 99999</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            ...
						            <tr>
						                ...
						                <td>AOSB 2</td>
						                <td>Earth</td>
						                <td>Twenty single attacks (1.82 each), minimum damage 1, followed by one single attack (26.50) capped at 99999</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>BSB 1</td>
						                <td>Fire / NE</td>
						                <td>Six group attacks (1.99 each), grants [Haste], [Attach Fire] and [Burst Mode] to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						                ...
						                <td>BSB 2</td>
						                <td>Fire / NE</td>
						                <td>Imperil Fire (2). Eight single attacks (1.88 each), causes Imperil Fire 20% for 25 seconds, grants Haste and Burst Mode to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB</td>
						                <td>Earth / Wind</td>
						                <td>En-earth. Ten single attacks (0.71 each), DEF +100% to the user for 25 seconds, grants Attach Earth and Sandwind Blade Follow-Up to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>LMR 2</td>
						                <td></td>
						                <td>20% chance to cause [Imperil Earth 10% (15s)] to the target after using an Earth attack on an enemy</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            ...
						            <tr>
						                ...
						                <td>USB 3</td>
						                <td>Wind / NE</td>
						                <td>En-wind. Ten single attacks (1.70 each), grants Attach Wind, High Quick Cast 2 and EX: Enlightened Yearning to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>AASB</td>
						                <td>Dark / NE</td>
						                <td>En-dark. Fifteen single attacks (0.60 each), grants Attach Dark, Awoken Dark, Damage Cap +10000 and Assassinate Follow-Up to the user	</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF6</td>
						                <td>Celes</td>
						                <td>Celes's Armguard</td>
						                <td>AASB 2</td>
						                <td>Holy / Ice / NE</td>
						                <td>Fifteen single attacks (0.60 each), grants [Awoken Invincible General], [Damage Cap +10000], [Twin Element Mode (Ice/Holy)] and [Runic Release Follow-Up] to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Arch Sword</td>
						                <td>USB 1</td>
						                <td>Holy / Ice / Wind / NE</td>
						                <td>Ten single attacks (0.69 each), grants High Runic, Spellblade +30% Boost and Spellblade Double to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>OSB</td>
						                <td>Holy / Wind</td>
						                <td>One single attack (11.00/12.00/13.00/14.00) capped at 99999 if the user took 5/12/20 WHT, BLK, BLU or SUM hits</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>SSB</td>
						                <td>NE</td>
						                <td>Five single attacks (1.58 each), grants [High Runic] to the user for 25 seconds</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Chain</td>
						                <td>FF6 Realm</td>
						                <td>Activates VI Chain (max 99, field +50%), grants [ATK, DEF, MAG and RES +30%] for 25 seconds, grants [Instant Cast 1]</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Glint+</td>
						                <td></td>
						                <td>Grants Change Machinery and High Quick Cast 2</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF6</td>
						                <td>Leo</td>
						                <td>Leo's Longcoat</td>
						                <td>BSB</td>
						                <td>Holy / Earth</td>
						                <td>Eight single attacks (0.94 each), ATK and RES +30% to all allies for 25 seconds, grants Haste and Burst Mode to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>AASB</td>
						                <td></td>
						                <td>[MAG and MND +50%] for 25 seconds, grants [Haste] and [Magical Quick Cast] to all allies, grants [Awoken Rhapsody] and [Fevered Rhapsody Follow-Up] to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF6</td>
						                <td>Strago</td>
						                <td>Strago's Cloak</td>
						                <td>BSB</td>
						                <td>Water / Wind / Earth</td>
						                <td>En-water. Seven group attacks (1.66 each), grants Haste, Attach Water and Burst Mode to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB</td>
						                <td>Ice / NE</td>
						                <td>En-ice. Ten random ranged attacks (0.68 each), ATK and RES +30% to the user for 25 seconds, grants Attach Ice and Snowball Toss Follow-Up to the user	</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>SSB</td>
						                <td></td>
						                <td>Grants Green Cherry for 3 turns</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						                ...
						                <td>LMR</td>
						                <td></td>
						                <td>Grants [Attach Ice] at the beginning of the battle</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						                ...
						                <td>USB 3</td>
						                <td>Dark / NE</td>
						                <td>En-dark. Ten single ranged attacks (0.71 each), grants Attach Dark, Quick Cast and Random Bet Follow-Up to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>SASB 1</td>
						                <td>Wind / NE</td>
						                <td>En-wind lv.3. Fifteen single attacks (0.60 each), grants [Attach Wind 3 with Stacking], [Damage Cap +10000] and [Synchro Mode] to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>AASB 2</td>
						                <td>Dark / NE</td>
						                <td>En-dark. Fifteen single attacks (0.60 each), grants Attach Dark, 100% Critical, Awoken Heavy Physical and Damage Cap +20000 to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB 3</td>
						                <td>Dark / NE</td>
						                <td>En-dark. Ten single attacks (0.71 each), grants Attach Dark, Heavy Charge Booster and Darkness Blow Follow-Up to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF7</td>
						                <td>Cloud</td>
						                <td>Anonymous Blade</td>
						                <td>Glint+ 2</td>
						                <td></td>
						                <td>Grants [Attach Dark Stacking], [Attach Dark] and [Instant Cast 1]</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						                ...
						                <td>Glint+ 4</td>
						                <td>Wind / Dark / NE</td>
						                <td>Three random attacks (0.69 each), 100% additional critical chance</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>TASB / Phase 1</td>
						                <td></td>
						                <td>Grants [Attach Earth with Stacking], [Damage Cap +10000], [True Arcane Augment Mode: Tifa], [Final Heaven Damage Tracker] and [Final Heaven Level]</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						                ...
						                <td>TASB / Phase 2</td>
						                <td>Earth / NE</td>
						                <td>Twenty single attacks (1.00/1.10/1.20 each) capped at 9999/19999/29999, followed by one single attack (10.00/11.00/12.00) capped at 99999 at Final Heaven level 0/1/2, removes True Arcane Augment Mode: Tifa from the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						                ...
						                <td>LBOF</td>
						                <td>Earth</td>
						                <td>Five single attacks (1.00 each scaling with LB gauge and LB honing level) capped at 99999, ignores DEF, 100% additional critical chance	</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF7</td>
						                <td>Yuffie</td>
						                <td>Treasure Armlet</td>
						                <td>AOSB 2</td>
						                <td>Earth</td>
						                <td>Three single ranged attacks (8.00 each) capped at 99999</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>AASB</td>
						                <td>Medica</td>
						                <td>Restores HP (105), removes KO (100% HP), grants Last Stand, Physical High Quick Cast 3 and Haste, grants Awoken Savior to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB 3</td>
						                <td>Fire / NE</td>
						                <td>En-fire. Ten single attacks (0.71 each), grants Attach Fire with Stacking, Critical Damage +50% and Instant Cast 1 to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB 2</td>
						                <td>Wind / NE</td>
						                <td>En-wind. Ten single attacks (0.71 each), grants Attach Wind, Rage Mirage Follow-Up and Raging Storm Follow-Up to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF7</td>
						                <td>Rufus</td>
						                <td>Premium Wristwatch</td>
						                <td>AASB</td>
						                <td>Dark / NE</td>
						                <td>En-dark. Fifteen single ranged attacks (0.60 each), grants Attach Dark, Awoken Dark, Damage Cap +10000 and Ground Dive Follow-Up to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF7</td>
						                <td>Red XIII</td>
						                <td>Diamond Barrette</td>
						                <td>AASB</td>
						                <td>Earth / NE</td>
						                <td>En-earth. Fifteen single attacks (1.50 each), grants Attach Earth, Awoken Earth, Damage Cap +10000, High Quick Cast and Howling Stone Follow-Up to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF7</td>
						                <td>Reno</td>
						                <td>Enhanced Pierce Rod</td>
						                <td>USB 1</td>
						                <td>Lightning / NE</td>
						                <td>En-lightning. Ten single hybrid ranged attacks (0.71 or 1.70 each), grants ATK/DEF or DEF/MAG +30%, Attach Lightning, Quick Cast 1 and Lightning Quick Cycle to the user	</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						                ...
						                <td>USB 2 / BUSB</td>
						                <td>Lightning</td>
						                <td>En-lightning. Ten single hybrid ranged attacks (0.72 or 1.73 each), grants Attach Lightning, Black Magic or Machinist +30% Boost and Brave Mode to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB</td>
						                <td>Fire / Wind</td>
						                <td>Fifteen random ranged attacks (0.45 each), DEF and RES -70% for 8 seconds, grants Instant Cast 1 to all allies</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						                <td>FF7</td>
						                <td>Barret</td>
						                <td>Enemy Launcher</td>
						                <td>Glint+</td>
						                <td></td>
						                <td>Grants Attach Fire Stacking, Attach Fire and High Quick Cast 2	</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>LMR</td>
						                <td></td>
						                <td>25% chance to dualcast abilities that deal Holy or Wind damage</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						                ...
						                <td>Glint 2</td>
						                <td></td>
						                <td>Grants [Linked Materia Mode II] and [High Quick Cast 1]</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>AASB</td>
						                <td>Lightning / NE</td>
						                <td>En-lightning. Fifteen single attacks (0.60 each), grants Attach Lightning, Awoken Stormborn, Damage Cap +10000, and Transparent Thunderclap Follow-Up to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Glint</td>
						                <td>Fire / NE</td>
						                <td>En-fire. Six single ranged attacks (0.52 each), grants Attach Fire Stacking and Attach Fire to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>LMR</td>
						                <td></td>
						                <td>25% chance to dualcast Sharpshooter abilities</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Glint</td>
						                <td>Fire / NE</td>
						                <td>En-fire. Six single hybrid ranged attacks (0.52 or 1.25 each), grants Attach Fire Stacking and Attach Fire to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>SSB 1</td>
						                <td>NE</td>
						                <td>Four group attacks (3.60 each), [MAG +20%] to all allies for 25 seconds</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>LMR 1</td>
						                <td></td>
						                <td>35% chance to grant Quick Cast 1 to the user after using a Monk ability</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>SASB</td>
						                <td>Wind / NE</td>
						                <td>Lv.3 En-wind. Fifteen single attacks (1.50), grants Attach Wind 3 with Stacking, Synchro Mode, Damage Cap +10000, High Quick Cast 1 and Wind High Quick Cycle to the user	</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Glint+</td>
						                <td></td>
						                <td>En-wind. Grants [Attach Wind Stacking], [Attach Wind] and [Instant Cast 1]</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>SASB</td>
						                <td>Ice / NE</td>
						                <td>Fifteen single ranged attacks (0.60 each), grants [Attach Ice 3 with Stacking], [Synchro Mode], [Damage Cap +10000], [Freezing Rain], Natural Talent +1 and [Tactical Shot Follow-Up] to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						                ...
						                <td>AASB 1</td>
						                <td>Ice / NE</td>
						                <td>Imperil Ice (2). Fifteen single ranged attacks (0.60 each), causes Medium Imperil Ice (25s), grants Attach Ice, Awoken Ice, Damage Cap +10000 and Deblizz Shot Follow-Up to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB 2</td>
						                <td>Ice / Dark</td>
						                <td>En-ice. Ten single attacks (1.70 each), MAG and RES +30% to the user for 25 seconds, grants Attach Ice and Astral World to the user	</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF8</td>
						                <td>Edea</td>
						                <td>Sorceress Gown</td>
						                <td>SSB 2</td>
						                <td>Dark</td>
						                <td>Imperil Dark (2). Five single attacks (3.56 each), causes Imperil Dark 20% for 25 seconds</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF8</td>
						                <td>Edea</td>
						                <td>Sorceress Crown+</td>
						                <td>LMR 1</td>
						                <td></td>
						                <td>35% chance to grant [Quick Cast 1] to the user after using a Ice attack</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF8</td>
						                <td>Selphie</td>
						                <td>Selphie's Bracelet</td>
						                <td>USB 2</td>
						                <td>Medica</td>
						                <td>Restores HP (85), grants Reraise: 40% and Astra</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Obelisk</td>
						                <td>AASB</td>
						                <td>Water / Ice / Earth / NE</td>
						                <td>Fifteen single ranged jump attacks (0.60 each), grants 100% Critical, Awoken Laguna Freak, Damage Cap +10000, Carrier Change Mode and Maximum Anchor Follow-Up to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						                ...
						                <td>USB</td>
						                <td>Water / Ice / Earth / NE</td>
						                <td>Ten single ranged attacks (0.69 each), grants Medium Buff Water/Ice/Earth and Carrier Change Mode II to the user, grants 50% Damage Reduction Barrier 1 to all allies</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						                ...
						                <td>LMR</td>
						                <td></td>
						                <td>PHY Damage +20% with Hat equipped</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            ...
						            <tr>
						                ...
						                <td>USB 1</td>
						                <td>Wind / NE</td>
						                <td>Imperil Wind (20). Ten random attacks (0.72 each), causes [Imperil Wind 20%] for 25 seconds, grants [EX: Master Thief] to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>OSB</td>
						                <td>Wind / NE</td>
						                <td>One single attack (11.80) capped at 99999, 12.80 multiplier if 4 or more females are in the party</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF9</td>
						                <td>Vivi</td>
						                <td>Frostflash Staff</td>
						                <td>AASB 2</td>
						                <td>Ice / Lightning / NE</td>
						                <td>Fifteen single attacks (2.50 each), grants Awoken Life, Damage Cap +10000, Twin Element Mode (Ice/Lightning) and Vivi Trance to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>LMR 1</td>
						                <td></td>
						                <td>Cast speed x0.77 for BLK attacks, BLK attacks deal 25% more damage</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Glint+</td>
						                <td></td>
						                <td>Grants Soul Break Gauge +500</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>BSB 2</td>
						                <td>Fire / Lightning / Ice</td>
						                <td>Eight single attacks (0.94 each), grants Haste, Sentinel and Burst Mode to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Glint</td>
						                <td></td>
						                <td>En-fire. Grants [Attach Fire Stacking], [Attach Fire] and [100% Critical 2] to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>BSB 1</td>
						                <td>Holy</td>
						                <td>Imperil Holy (2). Four group attacks (1.37 each), 1.53 multiplier if all allies are alive, causes Imperil Holy 20% for 25 seconds, grants Haste and Burst Mode to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>LMR 3</td>
						                <td></td>
						                <td>20% chance to cause [Imperil Holy 10% (15s)] to the target after using a Knight ability on an enemy</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>AASB</td>
						                <td></td>
						                <td>Grants ATK and MND +50%, Haste and Physical Quick Cast, grants Awoken Frog Catcher and Golden Frog Follow-Up to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF10</td>
						                <td>Tidus</td>
						                <td>Zanarkand Abes Uniform I</td>
						                <td>AASB</td>
						                <td>Water / NE</td>
						                <td>En-water. Fifteen single ranged attacks (0.60 each), grants Attach Water, Awoken Sharpshooter, Damage Cap +10000 and Ace Shot Follow-Up to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>LMR 2</td>
						                <td></td>
						                <td>35% chance to grant Quick Cast 1 to the user after using a Water attack</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						                ...
						                <td>AASB</td>
						                <td>Water / NE</td>
						                <td>En-water. Fifteen single jump attacks (0.60 each), grants Attach Water, Awoken Water, Damage Cap +10000 and No Air Time to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF10</td>
						                <td>Auron</td>
						                <td>Legendary Guardian</td>
						                <td>OSB</td>
						                <td>Fire / NE</td>
						                <td>One single attack (10.50~14.50 scaling with Samurai abilities used) capped at 99999</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						            	<td>FF10</td>
						            	<td>Auron</td>
						            	<td>Cerulean Bracer</td>
						            	<td>Glint 2</td>
						            	<td></td>
						            	<td>Imperil Fire (10). Six single attacks (0.52 each), causes Imperil Fire 10% and DEF -50% for 15 seconds</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>AASB</td>
						                <td>Holy / Wind / NE</td>
						                <td>Fifteen single attacks (1.32 each), restores HP (85) to all allies, grants [Regenga] to all allies, grants [Awoken Kindred] and [Damage Cap +10000] to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF10</td>
						                <td>Yuna</td>
						                <td>Reticent Staff</td>
						                <td>Glint+</td>
						                <td></td>
						                <td>Grants [Attach Holy Stacking] and [Attach Holy], grants [HP Stock (2000)] to all allies</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF10</td>
						                <td>Yuna</td>
						                <td>Songstress Yuna's Guise</td>
						                <td>Glint 2</td>
						                <td></td>
						                <td>Grants HP Stock (2000), grants Attach Holy to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						                <td>FF10</td>
						                <td>Yuna</td>
						                <td>Staff of Thorns</td>
						                <td>LMR 1</td>
						                <td></td>
						                <td>25% chance to dualcast Summoning abilities</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Glint</td>
						                <td></td>
						                <td>En-water. Grants Attach Water Stacking, Attach Water and Quick Cast 2</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>LMR 3</td>
						                <td></td>
						                <td>25% chance to dualcast abilities that deal Water damage</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						                <td>FF10</td>
						                <td>Paine</td>
						                <td>Full Throttle Sword</td>
						                <td>AASB</td>
						                <td>Water / NE</td>
						                <td>En-water. Fifteen single attacks (0.60 each), grants Attach Water, Awoken Water, Damage Cap +10000 and Respect Counter Mode to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF10</td>
						                <td>Paine</td>
						                <td>Full Throttle Blade</td>
						                <td>USB 2 / BUSB</td>
						                <td>Water / NE</td>
						                <td>En-water. Ten single attacks (0.72 each), grants Attach Water, Spellblade High Quick Cast 2 and Brave Mode to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						                ...
						                <td>USB 3</td>
						                <td>Water / NE</td>
						                <td>En-water. Ten single attacks (0.71 each), grants Attach Water, Speed Professional and Surfeit to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF11</td>
						                <td>Shantotto</td>
						                <td>Wizard's Petasos</td>
						                <td>AASB</td>
						                <td>Lightning / NE</td>
						                <td>En-lightning. Fifteen single attacks (1.50 each), grants Attach Lightning, Awoken Witch, Damage Cap +10000 and Play Rough Mode to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>LMR 1</td>
						                <td></td>
						                <td>10% chance to dualcast Witch abilities twice</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB 2</td>
						                <td>Medica</td>
						                <td>Causes Imperil Holy 20%, restores HP (85) to all allies, grants [Imperial Heal] and [Glimpse of Divinity Follow-Up] to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>AASB</td>
						                <td>Holy / NE</td>
						                <td>Fifteen single attacks (0.60 each), grants Attach Holy, Awoken Knight, Damage Cap +10000 and Vorpal Blade Follow-Up to the user	</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Glint+</td>
						                <td></td>
						                <td>Grants [Attach Holy Stacking], [Attach Holy] and [Knight Quick Cast]</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF11</td>
						                <td>Naja</td>
						                <td>Nashira Manteel</td>
						                <td>USB</td>
						                <td>Earth / NE</td>
						                <td>En-earth. Ten single attacks (0.71 each), grants Attach Earth, True Strike and Special Bonus to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            ...
						            <tr>
						                ...
						                <td>AASB</td>
						                <td>Lightning / NE</td>
						                <td>En-lightning. Fifteen single attacks (1.50 each), grants Attach Lightning, Awoken Lightning, Damage Cap +10000 and Wrathful Thunder Follow-Up to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF12</td>
						                <td>Larsa</td>
						                <td>Princely Raiment</td>
						                <td>BSB</td>
						                <td>Medica</td>
						                <td>Restores HP (85), grants [Astra], grants [Haste] and [Burst Mode] to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Glint+</td>
						                <td></td>
						                <td>Grants Twin Element Mode II (Holy/Fire) and High Quick Cast 1</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB 1</td>
						                <td>Fire / NE</td>
						                <td>En-fire. Ten single ranged attacks (0.71 each), grants Attach Fire, Quick Cast 1 and Machinist Quick Cycle: Fire to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>AASB</td>
						                <td>Dark / NE</td>
						                <td>En-dark. Fifteen single attacks (0.60 each), grants Attach Dark, Awoken Judge, Damage Cap +10000 and Quick Cast to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>OSB</td>
						                <td>Dark / Holy</td>
						                <td>One single hybrid attack (12.00 or 40.00) capped at 99999</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF12</td>
						                <td>Fran</td>
						                <td>Hunting Crossbow</td>
						                <td>USB 2</td>
						                <td>Ice / Lightning</td>
						                <td>Ten random ranged attacks (0.60 each), ATK, DEF and MAG -70% for 8 seconds, grants Instant Cast 1 to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>TASB / Phase 1</td>
						                <td></td>
						                <td>Grants [Attach Lightning with Stacking], [Damage Cap +10000], [True Arcane Augment Mode: Lightning], [Zantetsuken Ability Tracker] and [Zantetsuken Level]</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						                ...
						                <td>TASB / Phase 2</td>
						                <td>Lightning / NE</td>
						                <td>Twenty single attacks (1.00/1.10/1.20 each) capped at 9999/19999/29999, followed by one single attack (10.00/11.00/12.00) capped at 99999 at Zantetsuken level 0/1/2, removes True Arcane Augment Mode: Lightning from the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						                ...
						                <td>AASB</td>
						                <td>Lightning / NE</td>
						                <td>En-lightning. Fifteen single ranged attacks (0.60 each), grants Attach Lightning, Awoken Lightning, Damage Cap +10000 and Lightning Strikes Follow-Up to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>En-holy. Ten single attacks (0.71 each), grants [Attach Holy] and [EX: Knight of Etro] to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF13</td>
						                <td>Claire/Lightning</td>
						                <td>Lightning's Reprise</td>
						                <td>LMR 1</td>
						                <td></td>
						                <td>25% chance to dualcast abilities that deal Lightning damage	</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>BSB 2</td>
						                <td>Ice / NE</td>
						                <td>Imperil Ice (2). Ten random attacks (1.44 each), causes Imperil Ice 20% for 25 seconds, grants Haste and Burst Mode to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB 2</td>
						                <td>Holy</td>
						                <td>Ten single attacks (1.73 each), grants [Holy Radiant Shield: 75%] to all allies, grants [Saintly Arc Finisher] and [Beyond Enlightened Mode 0] to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF13</td>
						                <td>Noel</td>
						                <td>Avenger's Edge</td>
						                <td>Glint+ 2</td>
						                <td></td>
						                <td>Grants [Double Crystarium Mode II] and [High Quick Cast 1]</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF13</td>
						                <td>Fang</td>
						                <td>Heretic's Halberd</td>
						                <td>BSB 2</td>
						                <td>Wind / NE</td>
						                <td>En-wind. Nine single attacks (0.74 each), grants Haste, Attach Wind and Burst Mode to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>LMR 3</td>
						                <td></td>
						                <td>Grants Haste and Instant Cast 1 at the beginning of the battle</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						                ...
						                <td>SASB</td>
						                <td>Dark / Holy / NE</td>
						                <td>Fifteen single attacks (1.50 each), grants [DEF and MAG +30% (25s)] to all allies, grants [Synchro Mode], [Damage Cap +10000], [Double Crystarium Mode III (Dark/Holy)] and [Dawn] to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB 2</td>
						                <td>Dark / Holy</td>
						                <td>En-dark. Ten single attacks (1.70 each), DEF and MAG +30% to the user for 25 seconds, grants Attach Dark and Darkness Double to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF13</td>
						                <td>Vanille</td>
						                <td>Pearlwing Staff</td>
						                <td>USB 3</td>
						                <td></td>
						                <td>Causes [ATK, DEF, MAG and RES -40%] for 25 seconds, restores HP (85) to all allies, grants [Regenga] to all allies</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>LMR 1</td>
						                <td></td>
						                <td>25% chance to cast an ability (WHT: single, 2.00 magical Holy, DEF/RES -20%) after using a White Magic ability</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB 2 / BUSB</td>
						                <td>Dark</td>
						                <td>En-dark. Ten single attacks (1.73 each), grants Minor Buff Dark to all allies, grants Attach Dark and Brave Mode to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>AASB 2</td>
						                <td>Ice / NE</td>
						                <td>Fifteen single ranged attacks (0.60 each), grants [ATK, DEF, MAG and RES +30%] (25s)] to all allies, grants [HP Stock (2000)]/[HP Stock (3000)] and [Weakness +15% Boost]/[HP Stock (6000)] and [Weakness +30% Boost] to allies if 1/2-3/4+ XIII members are alive, grants [Awoken Ice], [Damage Cap +10000] and [Eternal Vow Mode] to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB 1</td>
						                <td>Ice</td>
						                <td>Ten single attacks (0.72 each), grants Ice Radiant Shield: 75% to all allies, grants Revenge Counter to the user	</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>AASB 1</td>
						                <td>Medica</td>
						                <td>Restores HP (105), grants Last Stand and Stoneskin: 30%, grants Awoken Guardian and High Quick Cast for 15 seconds to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						                <td>FF14</td>
						                <td>Y'shtola</td>
						                <td>Scion Sorceress's Headdress</td>
						                <td>AASB 2</td>
						                <td>Fire / Ice / Lightning / Dark / NE</td>
						                <td>Fifteen single attacks (1.50 each), grants [Awoken Sorceress of Dawn], [Damage Cap +10000], [Quad Element Mode (Fire, Ice, Lightning, Dark)] and [Night's Blessed Follow-Up] to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF14</td>
						                <td>Y'shtola</td>
						                <td>Ironworks Magitek Cane</td>
						                <td>USB 2 / BUSB</td>
						                <td>Medica</td>
						                <td>Restores HP (85), grants [Magical High Quick Cast 3], grants [Brave Mode] to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF14</td>
						                <td>Ysayle</td>
						                <td>Hailstorm Coat</td>
						                <td>BSB</td>
						                <td>Ice / NE</td>
						                <td>Six group attacks (2.16 each), causes [Imperil Ice 20%] for 25 seconds, grants [Haste] and [Burst Mode] to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF15</td>
						                <td>Aranea</td>
						                <td>A1-Class Powershield</td>
						                <td>USB</td>
						                <td>Lightning / Dark</td>
						                <td>En-lightning. Ten single ranged jump attacks (0.71 each), ATK and DEF +30% to the user for 25 seconds, grants Attach Lightning and Dragon Boost Follow-Up to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>AASB</td>
						                <td>Earth / NE</td>
						                <td>En-earth. Fifteen single attacks (0.60 each), grants Attach Earth, Awoken Earth, PHY +30% Boost, Break Arts Mode and Damage Cap +10000 to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FF4</td>
						                <td>Cid Orlandeau</td>
						                <td>Thunder God's Arch Sword</td>
						                <td>SASB</td>
						                <td>Holy / NE</td>
						                <td>Fifteen single attacks (0.60 each), grants [Attach Holy 3 with Stacking], [Thunder God's Might], [Synchro Mode], [Damage Cap +10000] and [Saintly Judgment Blade Follow-Up] to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>AASB</td>
						                <td>Medica</td>
						                <td>Grants [HP Stock (6000)], [Regenga], [Protect], [Shell], [Haste], [Reraise: 40%] and [75% Damage Reduction Barrier 1], grants [Awoken Love Mode] to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Glint+</td>
						                <td>Holy / NE</td>
						                <td>En-holy. Six single attacks (0.52 each), grants Attach Holy Stacking and Attach Holy to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FFT</td>
						                <td>Agrias</td>
						                <td>Agrias's Guise</td>
						                <td>AASB</td>
						                <td>Holy / NE</td>
						                <td>En-holy. Fifteen single attacks (0.60 each), grants Attach Holy, Awoken Knight, Damage Cap +10000 and Incandescent Sear Follow-Up to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FFT</td>
						                <td>Agrias</td>
						                <td>Venetian Shield</td>
						                <td>SSB 2</td>
						                <td>Holy / NE</td>
						                <td>En-shield. Seven single attacks (1.11 each), grants Attach Holy to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FFT</td>
						                <td>Delita</td>
						                <td>Delita's Armor</td>
						                <td>USB 2</td>
						                <td>Holy / Fire / Lightning / Ice</td>
						                <td>Ten single attacks (0.69 each), grants Critical Chance 75% to the user for 25 seconds, grants Quick Cast and Hero-King Blade Follow-Up to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB</td>
						                <td></td>
						                <td>Grants [Magical Blink 1] and [Instant Cast 1], [ATK, DEF, MAG and RES -70%] to all enemies for 8 seconds</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FFT0</td>
						                <td>Cinque</td>
						                <td>Seismic Shaker</td>
						                <td>SASB</td>
						                <td>Earth / Wind / NE</td>
						                <td>Lv.3 En-earth. Fifteen single attacks (0.60 each), grants Attach Earth 3 with Stacking, Synchro Mode, Damage Cap +10000, and Heavy Charge +2 to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>AASB</td>
						                <td>Lightning / NE</td>
						                <td>En-lightning. Fifteen single ranged attacks (0.60 each), grants Attach Lightning, Awoken Lightning, Damage Cap +10000, PHY +30% Boost and Unlock Trigger Mode to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Glint+</td>
						                <td></td>
						                <td>Grants [Attach Lightning with Stacking] and [Instant Cast 1] to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Glint+</td>
						                <td>Wind</td>
						                <td>En-wind. One single ranged jump attack (?), grants Attach Wind with Stacking to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB</td>
						                <td></td>
						                <td>En-dark. Ten single attacks (0.71 each), grants [Attach Dark], [Culling Scythe Finisher] and [Malice Mode 0] to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>FFT0</td>
						                <td>Deuce</td>
						                <td>Argentic Flute</td>
						                <td>USB 1</td>
						                <td>Medica</td>
						                <td>Restores HP (85), removes KO [Raise: 40%], grants [Stoneskin: 30%]</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB 1</td>
						                <td>Fire / NE</td>
						                <td>En-fire. Ten single attacks (1.70 each), grants [Attach Fire] to the user, grants [Ace Follow-Up] and [EX: Attack Hand] to the user for 15 seconds</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						                ...
						                <td>USB 2</td>
						                <td>Fire / NE</td>
						                <td>En-fire. Ten single attacks (1.70 each), grants Attach Fire, Black Magic +30% Boost and Top Card to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>Glint</td>
						                <td></td>
						                <td>En-ice. Grants [Attach Ice Stacking], [Attach Ice] and [Instant Cast 1]</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB</td>
						                <td>Ice / NE</td>
						                <td>Ten single attacks (1.70 each), causes [Imperil Ice 20%] for 25 seconds, grants [Deep Freeze Follow-Up] to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>Beyond</td>
						                <td>Lann</td>
						                <td>Yellow Alpha Arm</td>
						                <td>OSB</td>
						                <td>NE</td>
						                <td>One single attack (12.60) capped at 99999, 13.60 multiplier if Reynn is alive, causes Instant KO (60%)	</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB</td>
						                <td>Medica</td>
						                <td>Restores HP (85), grants HP Stock (2000) and Astra</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>Beyond</td>
						                <td>Enna Kros</td>
						                <td>Chocochick Mirage</td>
						                <td>USB</td>
						                <td>Earth / Holy</td>
						                <td>En-earth. Ten single attacks (1.70 each), grants Attach Earth, Black Magic Quick Cast and Sweet Coffee Follow-Up to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>SASB</td>
						                <td>Fire / Earth / NE</td>
						                <td>Fifteen single attacks (0.60 each), grants Synchro Mode, Damage Cap +-10000, Quick Cast, Twin Element Mode III (Fire/Earth) and Vagrant Knight Follow-Up to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						                ...
						                <td>AASB</td>
						                <td>Ice / Wind / NE</td>
						                <td>En-ice. Fifteen single attacks (0.60 each), grants Attach Ice, Awoken Samurai, Damage Cap +10000 and Azure Blade Follow-Up to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB</td>
						                <td>Ice / Wind / NE</td>
						                <td>En-ice. Ten single attacks (0.70 each), grants Attach Ice, Major Buff Ice, Short 50% Critical and Hyomonken Follow-Up to the user</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						                <td>Beyond</td>
						                <td>Lasswell</td>
						                <td>Lasswell's Wok</td>
						                <td>Glint+</td>
						                <td></td>
						                <td>En-ice. Grants Attach Ice with Stacking and Instant Cast 1</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>Core</td>
						                <td>Elarra</td>
						                <td>Magika Phoenix</td>
						                <td>AASB</td>
						                <td>Medica</td>
						                <td>Restores HP (105), removes KO (100% HP), grants Last Stand and Haste, grants Awoken Magika to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>USB 2</td>
						                <td>Medica</td>
						                <td>Restores HP (85), grants Critical Damage +50%, grants Quick Cast to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>Core</td>
						                <td>Tyro</td>
						                <td>Fantasy Grimoire Vol. I</td>
						                <td>AASB</td>
						                <td></td>
						                <td>Grants [50% Critical] and [Haste], [ATK and DEF +30%] for 25 seconds, grants [Awoken Keeper Mode] and [Unraveled History Follow-Up] to the user</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>Core</td>
						                <td>Tyro</td>
						                <td>Arbiter's Apocrypha</td>
						                <td>OSB</td>
						                <td>NE</td>
						                <td>One single attack (9.00) capped at 99999, ATK, DEF, MAG and RES +15% to all allies for 25 seconds</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                <td>Core</td>
						                <td>Dr. Mog</td>
						                <td>Bug Catching Net</td>
						                <td>AOSB 4</td>
						                <td>Water / Holy / Fire / Ice / Lightning</td>
						                <td>Three single attacks (17.00 each) capped at 99999</td>
						                <td></td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>LMR 3</td>
						                <td></td>
						                <td>Grants [Dr. Mog Trance] when HP fall below 20%</td>
						                <td><span class="fas fa-check icon n-green"><span class="n-1-hide">yes</span></span></td>
						                <td></td>
						            </tr>
